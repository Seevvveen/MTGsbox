...
namespace Sandbox.__Rewrite.Scryfall;

/// <summary>
/// Full Scryfall card object as returned by the oracle_cards bulk endpoint.
/// All fields are nullable where the API marks them optional.
/// </summary>
internal sealed class ScryfallCard
{
    ...
    [JsonPropertyName( "image_uris" )]       public object         ImageUris       { get; set; }
...
internal sealed class ScryfallRelatedCard
{
    [JsonPropertyName( "object" )]     public string Object    { get; set; }
    [JsonPropertyName( "id" )]         public string Id        { get; set; }
